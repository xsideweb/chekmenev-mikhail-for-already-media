...
//создаём новый блок
function unsplash_slider_register_acf_blocks() {
    /**
     ...
     */
    register_block_type( __DIR__ . '/blocks/unsplash_slider' );
}

add_action( 'init', 'unsplash_slider_register_acf_blocks' );

//подключение необходимых библиотек
require get_template_directory() . '/vendor/autoload.php';

//подключение к Api Unsplash
Unsplash\HttpClient::init([
    'applicationId' => 'QkDoF1tsFXdD5J4FFmSJhJSxM01-sTklJfO73NiOvvE',
    'secret'        => 'jHjZvX6lUTjIZoUc3LJACMznwHDJw0Z275dZdvQzcY8',
    'utmSource'     => 'Slider'
]);

//подключение скриптов и стилей Swiper
function enqueue_swiper() {
    wp_enqueue_style('swiper-css', get_template_directory_uri() . '/swiper/swiper-bundle.min.css');

    wp_enqueue_script('swiper-js', get_template_directory_uri() . '/swiper/swiper-bundle.min.js', array('jquery'), null, true);
}
